<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :md="4" :sm="4">
            <a-form-item label="消息标题">
              <a-input placeholder="消息标题" v-model="queryParam.esTitle"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="4" :sm="4">
            <a-form-item label="发送内容">
              <a-input placeholder="发送内容" v-model="queryParam.esContent"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="4" :sm="4">
              <a-form-item label="接收人">
                <a-input placeholder="接收人" v-model="queryParam.esReceiver"></a-input>
              </a-form-item>
            </a-col>
          <a-col :md="6" :sm="8">
    ...
    <!-- table区域-begin -->
    <div>
      <div class="ant-alert ant-alert-info" style="margin-bottom: 16px;height: 50px;line-height: 50px;padding-top: 0;padding-bottom: 0">
